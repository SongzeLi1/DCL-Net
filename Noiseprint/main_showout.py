...
imgfilename = r'D:\datasets\new_co\Columbia\canong3_kodakdcs330_sub_03.tif'
outfilename =r'C:\Users\CT\Desktop\SRM\canong3_kodakdcs330_sub_03.mat'
...
if 'noiseprint' in dat.keys():
    ...
    resshow = res-res.clip(vmin,vmax)
    plt.figure()
    plt.subplot(1,2,1)
    ...
    # plt.imshow(res,  clim=[vmin,vmax],cmap='gray')
    ...
    plt.axis('off')
    plt.imshow(res.clip(vmin, vmax), clim=[vmin, vmax], cmap='gray')
    # plt.savefig(r'C:\Users\CT\Desktop\pic\noise.png')
    plt.show()
