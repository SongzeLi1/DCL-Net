...
testresult_dir = '/pubdata/zhengkengtao/exps/1315_DIFNetV2_docimgsplit811_crop512train_ConvNeXttiny-UperNet-gcAtt-noAug_add_encoderContraLoss_ppmf-temperature0.07/difnetv2_512x512/testdocimgsplit811_bestepoch159/'
# testsize = 512
# map_path = testresult_dir + 'map{}x{}/'.format(testsize, testsize)
# pred_path = testresult_dir +  'pred{}x{}/'.format(testsize, testsize)
