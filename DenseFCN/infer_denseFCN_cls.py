...
from futils.utils import inial_logger
...
if __name__ == "__main__":
    ...
    stride = 512
    checkpoint_dir = '/data1/zhengkengtao/exps/1421_denseFCN_docimgsplit811_crop512train_Alltrainvalorig_Cls_noAug/denseFCN_512x512/fold_0_best-ckpt.pth'
    save_results_path = '/data1/zhengkengtao/exps/1421_denseFCN_docimgsplit811_crop512train_Alltrainvalorig_Cls_noAug/denseFCN_512x512/' \
                        'testepoch94_docimgsplit811_Orig200Psc200Mosaic200Ps200_crop512stride{}/'.format(stride)
