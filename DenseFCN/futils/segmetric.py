...
if __name__ == '__main__':
    imgPredict = cv2.imread('/pubdata/zhengkengtao/DocImg/PS/tamper_mosaic_trainvalsplit0.99/val_labels/honor_30_m7_320_ps_rem_c.png')
    imgLabel = cv2.imread('/pubdata/zhengkengtao/DocImg/PS/tamper_mosaic_trainvalsplit0.99/val_labels/huawei_mate30_m3_329_ps_add_c.png')
    imgPredict = imgPredict[:512,:512]
    imgLabel = imgLabel[:512,:512]
    print(imgPredict.max(), imgLabel.max())
