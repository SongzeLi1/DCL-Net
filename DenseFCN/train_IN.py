...
#                        '/pubdata/zhengkengtao/certificate/tamper_crop_512/',
#                        'path to dataset')
# vld_dataset = '/pubdata/zhengkengtao/certificate/tamper_crop_512/'
tf.flags.DEFINE_string('data_dir',
                       '/pubdata/zhengkengtao/Ali_new/forgery_round1_train_20220217/train/tamper/',
                       'path to dataset')
vld_dataset = '/pubdata/zhengkengtao/Ali_new/forgery_round1_train_20220217/train/tamper/'
...
tf.flags.DEFINE_integer('epoch', 200, 'No. of epoch to run')
tf.flags.DEFINE_float('train_ratio', 1.0, 'Trainning ratio')
# tf.flags.DEFINE_string('restore', '', 'Explicitly restore checkpoint')
tf.flags.DEFINE_string('restore', '/home/zhengkengtao/codes/Dense-FCN/models/TrainedWithCompetition/model.ckpt-0.513125-0.760782-30', 'Explicitly restore checkpoint')
...
tf.flags.DEFINE_string('logdir', '/pubdata/zhengkengtao/denseFCN_Alis3/Alinew_round1_train_results_finetuneWith_Alis3_denseFCN_IN_2/',
...
def main(argv=None):
	...
	if 'tamper' in FLAGS.data_dir:
		...
		pattern_train = 'train'
		msk_rep_train = [['tamper', 'mask'], ['jpg', 'png']]
		pattern_val = 'val'
		msk_rep_val = [['tamper', 'mask'], ['jpg', 'png']]
