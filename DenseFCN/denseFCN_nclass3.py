...
# 原始的denseFCN，用BN层
def denseFCN(inputs, is_training, weight_decay=5e-4, num_classes=3):
    processed_image = inputs - np.array([123.68, 116.78, 103.94]) / 255.0
    '''Densely block1 '''
    conv1 = tf.layers.conv2d(processed_image, filters=8, kernel_size=(3, 3),
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay), strides=(1, 1),
                             padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv1')
    ...
    conv2 = tf.layers.conv2d(conv2_input, filters=8, kernel_size=(3, 3), strides=(1, 1),
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay), padding='SAME',
    ...
    conv3 = tf.layers.conv2d(conv3_input, filters=8, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv3',
    ...
    conv4 = tf.layers.conv2d(conv4_input, filters=8, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv4',
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    ...
    block1_transition = tf.layers.conv2d(densely_block1_output, filters=16, kernel_size=(1, 1), padding='SAME',
                                         use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                                         name='block1_transition',
                                         kernel_regularizer=regularizers.l2_regularizer(weight_decay))

    pool1 = tf.layers.average_pooling2d(block1_transition, pool_size=(2, 2), strides=(2, 2), padding='SAME',
                                        name='pool1')

    '''Densely block2 '''
    conv5 = tf.layers.conv2d(pool1, filters=16, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                             use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                             name='conv5', kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    ...
    conv6 = tf.layers.conv2d(conv6_input, filters=16, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv6',
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    ...
    conv7 = tf.layers.conv2d(pool2, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                             use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                             name='conv7', kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    ...
    conv8 = tf.layers.conv2d(conv8_input, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv8',
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    ...
    conv10 = tf.nn.atrous_conv2d(conv10_input, filters=tf.get_variable("dilate_weight2", shape=[3, 3, 128, 64],
                                                                       initializer=initializers.variance_scaling_initializer()),
                                 rate=2, padding='SAME', name='conv10')
    ...
    block4_transition = tf.layers.conv2d(densely_block4_output, filters=96, kernel_size=(1, 1), padding='SAME',
                                         use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                                         name='block4_transition',
                                         kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    '''Densely block5 '''
    conv11 = tf.nn.atrous_conv2d(block4_transition, filters=tf.get_variable("dilate_weight3", shape=[3, 3, 96, 96],
                                                                            initializer=initializers.variance_scaling_initializer()),
                                 rate=2, padding='SAME', name='conv11')
    ...
    conv12 = tf.nn.atrous_conv2d(conv12_input, filters=tf.get_variable("dilate_weight4", shape=[3, 3, 192, 96],
                                                                       initializer=initializers.variance_scaling_initializer()),
                                 rate=2, padding='SAME', name='conv12')
    ...
    block5_transition = tf.layers.conv2d(densely_block5_output, filters=96, kernel_size=(1, 1), padding='SAME',
                                         use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                                         name='block5_transition',
                                         kernel_regularizer=regularizers.l2_regularizer(weight_decay))

    '''de_conv #1 '''
    de_conv1_shape = tf.shape(block3_transition)
    net1 = tf.nn.conv2d_transpose(block5_transition,
                                  tf.get_variable('bilinear_kernel1', dtype=tf.float32, shape=[4, 4, 64, 96],
                                                  initializer=tf.constant_initializer(
                                                      bilinear_upsample_weights(2, 64, 96), verify_shape=True),
                                                  regularizer=regularizers.l2_regularizer(weight_decay)),
                                  [de_conv1_shape[0], de_conv1_shape[1], de_conv1_shape[2], 64], strides=[1, 2, 2, 1],
                                  padding='SAME', name='de_conv1')
    ...
    conv14 = tf.layers.conv2d(conv14_input, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                              use_bias=True,
    ...
    net2 = tf.nn.conv2d_transpose(de_conv2_input,
                                  tf.get_variable('bilinear_kernel2', dtype=tf.float32, shape=[4, 4, 48, 64],
                                                  initializer=tf.constant_initializer(
    ...
    preds_msk = tf.cast(tf.greater_equal(preds_msk_map, 0.3), tf.int32)

    return logits_msk, preds_msk, preds_msk_map


# 改动的denseFCN，用IN层
def denseFCN_original_instanceNorm(inputs, is_training, weight_decay=5e-4, num_classes=3):
    processed_image = inputs - np.array([123.68, 116.78, 103.94]) / 255.0
    '''Densely block1 '''
    conv1 = tf.layers.conv2d(processed_image, filters=8, kernel_size=(3, 3),
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay), strides=(1, 1),
                             padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv1')
    norm1 = slim.instance_norm(conv1, scope='norm1')
    ...
    conv2 = tf.layers.conv2d(conv2_input, filters=8, kernel_size=(3, 3), strides=(1, 1),
                             ...
                             use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                             name='conv2')
    norm2 = slim.instance_norm(conv2, scope='norm2')
    norm2_activation = tf.nn.relu(norm2, name='norm2_activation')
    ...
    conv3 = tf.layers.conv2d(conv3_input, filters=8, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv3',
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm3 = slim.instance_norm(conv3, scope='norm3')
    norm3_activation = tf.nn.relu(norm3, name='norm3_activation')
    ...
    conv4 = tf.layers.conv2d(conv4_input, filters=8, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv4',
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm4 = slim.instance_norm(conv4, scope='norm4')
    norm4_activation = tf.nn.relu(norm4, name='norm4_activation')
    ...
    conv5 = tf.layers.conv2d(pool1, filters=16, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                             use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                             name='conv5', kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm5 = slim.instance_norm(conv5, scope='norm5')
    norm5_activation = tf.nn.relu(norm5, name='norm5_activation')
    ...
    conv6 = tf.layers.conv2d(conv6_input, filters=16, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv6',
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm6 = slim.instance_norm(conv6, scope='norm6')
    norm6_activation = tf.nn.relu(norm6, name='norm6_activation')
    ...
    conv7 = tf.layers.conv2d(pool2, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                             use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                             name='conv7', kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm7 = slim.instance_norm(conv7, scope='norm7')
    norm7_activation = tf.nn.relu(norm7, name='norm7_activation')
    ...
    conv8 = tf.layers.conv2d(conv8_input, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME', use_bias=True,
                             kernel_initializer=initializers.variance_scaling_initializer(), name='conv8',
                             kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm8 = slim.instance_norm(conv8, scope='norm8')
    norm8_activation = tf.nn.relu(norm8, name='norm8_activation')
    densely_block3_output = tf.concat([pool2, norm7_activation, norm8_activation], axis=-1)
    ...
    conv9 = tf.nn.atrous_conv2d(pool3, filters=tf.get_variable("dilate_weight1", shape=[3, 3, 64, 64],
                                                               initializer=initializers.variance_scaling_initializer()),
                                rate=2, padding='SAME', name='conv9')
    norm9 = slim.instance_norm(conv9, scope='norm9')
    norm9_activation = tf.nn.relu(norm9, name='norm9_activation')
    ...
    conv10 = tf.nn.atrous_conv2d(conv10_input, filters=tf.get_variable("dilate_weight2", shape=[3, 3, 128, 64],
                                                                       initializer=initializers.variance_scaling_initializer()),
                                 rate=2, padding='SAME', name='conv10')
    norm10 = slim.instance_norm(conv10, scope='conv10')
    norm10_activation = tf.nn.relu(norm10, name='norm10_activation')
    ...
    norm11 = slim.instance_norm(conv11, scope='norm11')
    norm11_activation = tf.nn.relu(norm11, name='norm11_activation')
    ...
    conv12 = tf.nn.atrous_conv2d(conv12_input, filters=tf.get_variable("dilate_weight4", shape=[3, 3, 192, 96],
                                                                       initializer=initializers.variance_scaling_initializer()),
                                 rate=2, padding='SAME', name='conv12')
    norm12 = slim.instance_norm(conv12, scope='norm12')
    norm12_activation = tf.nn.relu(norm12, name='norm12_activation')
    ...
    conv13 = tf.layers.conv2d(net1, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                              use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                              name='conv13', kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm13 = slim.instance_norm(conv13, scope='norm13')
    norm13_activation = tf.nn.relu(norm13, name='norm13_activation')
    ...
    conv14 = tf.layers.conv2d(conv14_input, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                              ...
                              kernel_initializer=initializers.variance_scaling_initializer(), name='conv14',
                              kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm14 = slim.instance_norm(conv14, scope='norm14')
    norm14_activation = tf.nn.relu(norm14, name='norm14_activation')
    ...
    conv15 = tf.layers.conv2d(net2, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                              use_bias=True, kernel_initializer=initializers.variance_scaling_initializer(),
                              name='conv15', kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm15 = slim.instance_norm(conv15, scope='norm15')
    norm15_activation = tf.nn.relu(norm15, name='norm15_activation')
    ...
    conv16 = tf.layers.conv2d(conv16_input, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='SAME',
                              ...
                              kernel_initializer=initializers.variance_scaling_initializer(), name='conv16',
                              kernel_regularizer=regularizers.l2_regularizer(weight_decay))
    norm16 = slim.instance_norm(conv16, scope='norm16')
    norm16_activation = tf.nn.relu(norm16, name='norm16_activation')
