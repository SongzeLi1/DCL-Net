...
from utils.deeplearning_rru_nclass3 import *
import warnings
...
if __name__ == '__main__':
    ...
    param['batch_size'] = 6*6      # 批大小
    param['disp_inter'] = 1      # 显示间隔(epoch)
    param['iter_inter'] = 50     # 显示迭代间隔(batch)
    param['min_inter'] = 10
    param['backbone'] = 'rru'        # efficientnet-b2 se_resnext101_32x4d efficientnet-b7 convnext rru
    param['model_name'] = 'rru'         # 模型名称 DeepLabV3Plus UnetPlusPlus difnet rru
    param['save_train_dir'] = '/pubdata/zhengkengtao/exps/0728_RRUNet-nclass3_docimg_split811_png_noAug_focal+cosinelr+AdamWoptimizer/'
    ...
    param['load_ckpt_dir'] = '/pubdata/zhengkengtao/exps/0728_RRUNet-nclass3_docimg_split811_png_noAug_focal+cosinelr+AdamWoptimizer/rru_512x512/latest-ckpt-full.pth'
    param['save_ckpt_dir'] = save_ckpt_dir    # 权重保存路径
    param['T0'] = 3  # cosine warmup的参数rru_512x512
    ...
    if param['multifold_train'] == False:
        ...
        model = Ringed_Res_Unet(n_channels=3, n_classes=3)
        # print(model)
