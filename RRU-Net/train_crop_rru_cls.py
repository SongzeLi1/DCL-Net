...
from networks.rrunet.unet_model_cls import *
import warnings
import glob
...
def train_net(fold, logger, param, model, train_data, valid_data):
    ...
    best_epoch = 36
    best_score = 0.9410
    lowestloss_train_epoch = 44
    lowest_train_epoch_loss = 0.0245
...
if __name__ == '__main__':
    ...
    # python train_crop_rru_cls_noAug.py
    ...
    param['batch_size'] = 3*18     # 批大小
    param['iter_inter'] = 130     # 显示迭代间隔(batch)
    param['backbone'] = 'rru'        # efficientnet-b2 se_resnext101_32x4d efficientnet-b7 convnext se_resnet50 convnext
    param['model_name'] = 'rru'         # 模型名称 DeepLabV3Plus UnetPlusPlus difnet
    param['save_train_dir'] = '/pubdata/zhengkengtao/exps/1421_rru_docimgsplit811_crop512train_Alltrainvalorig_Cls_noAug/'
    ...
    param['load_ckpt_dir'] = '/pubdata/zhengkengtao/exps/1421_rru_docimgsplit811_crop512train_Alltrainvalorig_Cls_noAug/rru_512x512/latest-ckpt-full.pth'
    ...
    train_names = glob.glob('/pubdata/zhengkengtao/docimg/docimg_split811/crop512x512/train_images/*.png') + \
                  glob.glob('/pubdata/zhengkengtao/docimg/docimg_split811/train_images_orig_crop512stride512/*.png')  # [::3]
    train_names.sort()
    # train_names = train_names[:5*18*2]
    val_names = glob.glob('/pubdata/zhengkengtao/docimg/docimg_split811/crop512x512/val_images/*.png') + \
                glob.glob('/pubdata/zhengkengtao/docimg/docimg_split811/val_images_orig_crop512stride512/*.png')  # [::3]
    val_names.sort()
    # val_names = val_names[:5*18*2]
    ...
    model = Ringed_Res_Unet_cls(n_channels=3)
