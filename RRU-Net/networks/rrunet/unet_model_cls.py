from networks.rrunet.unet_parts import *
...
class Ringed_Res_Unet_cls(nn.Module):
    def __init__(self, n_channels=3):
        super(Ringed_Res_Unet_cls, self).__init__()
...
if __name__ == "__main__":
    ...
    net = Ringed_Res_Unet_cls(n_channels=3)
    net = net.cuda()
    output = net(img)
    print('output:', output.shape)
    # # print(output)
    # net2 = Ringed_Res_Unet(n_channels=3, n_classes=2)
    # net2 = net2.cuda()
    # output2 = net2(img)
