...
if __name__ == "__main__":
    ...
    stride = 512
    checkpoint_dir = '/data1/zhengkengtao/exps/1421_rru_docimgsplit811_crop512train_Alltrainvalorig_Cls_noAug/rru_512x512/fold_0_best-ckpt.pth'
    save_results_path = '/data1/zhengkengtao/exps/1421_rru_docimgsplit811_crop512train_Alltrainvalorig_Cls_noAug/rru_512x512/' \
                        'testepoch36_docimgsplit811_Orig200Psc200Mosaic200Ps200_crop512stride{}/'.format(stride)
    ...
    logger.info(
        'nclass:{}, mask_threshold:{}, viz:{}, save_mask:{}, batch_size:{}'.format(n_class, mask_threshold, viz, save_mask, batch_size))
