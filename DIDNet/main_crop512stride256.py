...
# python main_crop512stride256.py
...
def parse_args():
    ...
    parser.add_argument('--save_result_dir', type=str, default='/data1/zhengkengtao/exps/1424_DIDNet_docimgsplit811_crop512train_Cls_noAug/')
...
def main(cfg):
    ...
    train_list_tamper = read_list('/data1/zhengkengtao/docimg/docimg_split811/crop512x512/select/train_tamper/', mode="tamper")
    lenght = len(train_list_tamper)
    train_list_real = read_list('/data1/zhengkengtao/docimg/docimg_split811/crop512x512/select/train_real/', mode="real", subsample=lenght)
    print(lenght)
    val_list_tamper = read_list('/data1/zhengkengtao/docimg/docimg_split811/crop512x512/select/val_tamper/', mode="tamper")
    lenght = len(val_list_tamper)
    val_list_real = read_list('/data1/zhengkengtao/docimg/docimg_split811/crop512x512/select/val_real/', mode="real", subsample=lenght)
    print(lenght)
    test_list_tamper = read_list('/data1/zhengkengtao/docimg/docimg_split811/crop512x512/select/test_tamper/', mode="tamper")
    lenght = len(test_list_tamper)
    test_list_real = read_list('/data1/zhengkengtao/docimg/docimg_split811/crop512x512/select/test_real/', mode="real", subsample=lenght)
    print(lenght)
