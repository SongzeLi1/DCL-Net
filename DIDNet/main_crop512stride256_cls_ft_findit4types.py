...
# python main_crop512stride256_cls_ft_findit4types.py
...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=0.00003, help='initial learning rate') # 0.0003 ft 0.00003
    ...
    parser.add_argument('--save_result_dir', type=str, default='/data1/zhengkengtao/exps/1424_DIDNet_docimgsplit811_crop512train_Cls_noAug/1527_ft_findit4typessplit100-20-600_noAug/')
    parser.add_argument('--pretrain_ckpt', type=str, default='/data1/zhengkengtao/exps/1424_DIDNet_docimgsplit811_crop512train_Cls_noAug/DIDNet_epoch_43.pth')
...
def main(cfg):
    ...
    # ### 图像二分类 crop512stride256
    train_list_tamper = read_list('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/DIDNetcrop/train_tamper/', mode="tamper")
    lenght = len(train_list_tamper)
    train_list_real = read_list('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/DIDNetcrop/train_real/', mode="real", subsample=lenght)
    print(lenght)
    val_list_tamper = read_list('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/DIDNetcrop/val_tamper/', mode="tamper")
    lenght = len(val_list_tamper)
    val_list_real = read_list('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/DIDNetcrop/val_real/', mode="real", subsample=lenght)
    print(lenght)
    test_list_tamper = read_list('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/DIDNetcrop/test_tamper/', mode="tamper")
    lenght = len(test_list_tamper)
    test_list_real = read_list('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/DIDNetcrop/test_real/', mode="real", subsample=lenght)
    print(lenght)
