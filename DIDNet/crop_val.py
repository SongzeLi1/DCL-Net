...
# # ----------裁剪Alinew-----------------------------------------------------------------------------------------------
# tamper_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/val_imgs/'
# mask_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/val_gt/'
# print(len(os.listdir(mask_path)))
# d = 64 # 裁剪的图像大小
# tamper_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/DIDNetcrop/val_imgs_crop_64x64/'
# mask_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/DIDNetcrop/val_gt_crop_64x64/'
# if not os.path.exists(tamper_crop_path): os.makedirs(tamper_crop_path)
# if not os.path.exists(mask_crop_path): os.makedirs(mask_crop_path)
#
# # tamper_crop_names = os.listdir(tamper_crop_path)
...
# imgs_name = os.listdir(tamper_path)
# imgs_name.sort()
# # imgs_name = imgs_name[0*500:1*500]
# file_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/DIDNetcrop/crop64_val_log.txt'
# with open(file_path, 'r') as f:
#     for line in f:
#         cropped_img = line.strip('\n')
#         imgs_name.remove(cropped_img)
...
# tamper_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/DIDNetcrop/val_imgs_crop_64x64/'
# mask_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/DIDNetcrop/val_gt_crop_64x64/'
# select_tamper_dir = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/DIDNetcrop/val_tamper/'
# select_real_dir = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split_1000_200_2800/DIDNetcrop/val_real/'
# if not os.path.exists(select_tamper_dir): os.makedirs(select_tamper_dir)
# if not os.path.exists(select_real_dir): os.makedirs(select_real_dir)
# imgs_name = os.listdir(tamper_crop_path)
# imgs_name.sort()
...
# ----------裁剪Alinew-----------------------------------------------------------------------------------------------
tamper_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/val_imgs/'
mask_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/val_gt/'
print(len(os.listdir(mask_path)))
d = 64 # 裁剪的图像大小
tamper_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/DIDNetcrop/val_imgs_crop_64x64/'
mask_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/DIDNetcrop/val_gt_crop_64x64/'
if not os.path.exists(tamper_crop_path): os.makedirs(tamper_crop_path)
if not os.path.exists(mask_crop_path): os.makedirs(mask_crop_path)
...
file_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/DIDNetcrop/crop64_val_log.txt'
with open(file_path, 'r') as f:
    for line in f:
        cropped_img = line.strip('\n')
        imgs_name.remove(cropped_img)
...
tamper_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/DIDNetcrop/val_imgs_crop_64x64/'
mask_crop_path = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/DIDNetcrop/val_gt_crop_64x64/'
select_tamper_dir = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/DIDNetcrop/val_tamper/'
select_real_dir = '/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/train_split118/DIDNetcrop/val_real/'
if not os.path.exists(select_tamper_dir): os.makedirs(select_tamper_dir)
if not os.path.exists(select_real_dir): os.makedirs(select_real_dir)
imgs_name = os.listdir(tamper_crop_path)
imgs_name.sort()
