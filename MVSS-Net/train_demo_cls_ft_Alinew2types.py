...
# python train_demo_cls_ft_Alinew2types.py
...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_size", type=int, default=6*3)
    ...
    train_root = ['/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/Alinew2types/split_1000_200_2800/train_imgs']
    valid_root = ['/data1/zhengkengtao/Ali_new/forgery_round1_train_20220217/Alinew2types/split_1000_200_2800/val_imgs']
    test_root = None

    train_resize = (512, 512)
    resize = train_resize

    save_path = os.path.join('/data1/zhengkengtao/exps/1427_mvss_docimgsplit811_crop512train_Cls_noAug_adddata/1527_ft_Alinew2types_noAug/')
    main()
