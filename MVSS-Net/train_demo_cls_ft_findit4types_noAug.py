...
from utils_cls_findit4types import read_dataset
from shutil import rmtree
from tee_print import TeePrint
from utils_cls_findit4types import MyDataset, time_calucate, data_path
...
# python train_demo_cls_ft_findit4types_noAug.py
os.environ["CUDA_VISIBLE_DEVICES"] = '2'

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--Epoch", type=int, default=300)
    parser.add_argument("--lr",    type=float, default=1e-5) # ft 1e-5
    ...
    parser.add_argument("--batch_size", type=int, default=6*1)
    parser.add_argument("--lr_decay", type=float, default=0.5)
    parser.add_argument("--mode", type=str, default='train')
    parser.add_argument("--loss", type=str, default='dice')
    parser.add_argument('--restore_path', type=str, default='/data1/zhengkengtao/exps/1427_mvss_docimgsplit811_crop512train_Cls_noAug_adddata/9_acc_1.971_f1_0.113_clsacc_0.876_lr_0.0001.pkl')
    ...
    train_root = ['/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/train_imgs_crop512stride512']
    valid_root = ['/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/val_imgs_crop512stride512']
    test_root = None

    train_resize = None # 必须为None
    resize = train_resize

    save_path = os.path.join('/data1/zhengkengtao/exps/1427_mvss_docimgsplit811_crop512train_Cls_noAug_adddata/1527_ft_findit4typessplit100-20-600_noAug/')
    main()
