...
if __name__ == '__main__':
    ...
    train_resize = (512, 512) # docimg (512, 512) Alinew (768, 768) None
    resize = train_resize
    print('resize:', resize)

    save_path = os.path.join('/data1/zhengkengtao/exps/1111_MVSSNet_docimg_split811_png_OrigMosaicOneKind/')
    main()
