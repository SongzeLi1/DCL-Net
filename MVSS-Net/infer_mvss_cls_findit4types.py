...
class DOCDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        gt3name = name.replace('imgs', 'gt3')
        n = gt3name.split('/')[-1]
        nn = 'gt3_' + n
        gt3name = gt3name[:gt3name.index(n)] + nn
        # print(name)
        # print(gt3name)
...
if __name__=="__main__":
    ...
    #                     'testepoch9_fint4types720_crop512stride{}/'.format(stride)
    checkpoint_dir = '/data1/zhengkengtao/exps/1427_mvss_docimgsplit811_crop512train_Cls_noAug_adddata/1527_ft_findit4typessplit100-20-600_noAug/2_acc_1.995_f1_0.0_clsacc_0.521_lr_1e-05.pkl'
    save_results_path = '/data1/zhengkengtao/exps/1427_mvss_docimgsplit811_crop512train_Cls_noAug_adddata/1527_ft_findit4typessplit100-20-600_noAug/test_findit4types600_crop512stride{}/'.format(stride)
    ...
    # # 图像块
    # filenames = glob.glob('/data1/zhengkengtao/findit/findit_4types/imgs_crop512stride512/*.png'.format(stride))
    # filenames.sort()
    # # 整图
    # image_name_list = glob.glob('/data1/zhengkengtao/findit/findit_4types/imgs/*.jpg')
    # image_name_list.sort()


    # 图像块
    filenames = glob.glob('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride512/test_imgs_crop512stride512/*.png'.format(stride))
    filenames.sort()
    # 整图
    image_name_list = glob.glob('/data1/zhengkengtao/findit/findit_4types/split_100_20_600/test_imgs/*.jpg')
    image_name_list.sort()
