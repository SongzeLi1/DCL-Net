...
def main():
    ...
    if args.mode == 'train':
        ...
        # docimg png   findittypes_crop png
...
if __name__ == '__main__':
    ...
    # python train_demo_nclass3_ft_findit4types.py
    ...
    parser.add_argument("--batch_size", type=int, default=6*7)
    parser.add_argument("--lr_decay", type=float, default=0.5)
    parser.add_argument("--mode", type=str, default='train')
    parser.add_argument("--loss", type=str, default='dice')
    # parser.add_argument('--restore_path', type=str, default=None)
    parser.add_argument('--restore_path', type=str, default='/data1/zhengkengtao/exps/0728_MVSSNet_docimg_split811_crop512noblank_nclass3_Aug_1/140_acc_0.878_f1_0.603_lr_0.0001.pkl')
    ...
    train_root = ['/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride256/select_noblank/train_imgs',
                  '/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride256/select_blank/train_imgs_select500']
    valid_root = ['/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride256/select_noblank/val_imgs',
                  '/data1/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride256/select_blank/val_imgs_select50']
    test_root = None
    print(train_root)
    print(valid_root)
    print(test_root)
    ...
    save_path = os.path.join('/data1/zhengkengtao/exps/1526_MVSSNet-nlcass3_docimgsplit811pngAug_ft_findit4types_noAug_TRY/')
    main()
