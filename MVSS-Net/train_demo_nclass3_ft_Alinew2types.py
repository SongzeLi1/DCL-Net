...
def train(train_loader, valid_loader, optimizer, current_epoch, print_func):
    ...
    for epoch in range(args.Epoch)[current_epoch:]:
        ...
        for step, data in enumerate(train_loader):
            ...
            # print(outputs.shape)
            # print(labels.shape)
            # print(edg_labels.shape)
            # print(edg_labels)
            # print(np.unique(edg_labels))
...
if __name__ == '__main__':
    ...
    # python train_demo_nclass3_ft_Alinew2types.py
    ...
    save_path = os.path.join('/data1/zhengkengtao/exps/0728_MVSSNet_docimg_split811_crop512noblank_nclass3_Aug_1/1528_mvss-nclass3_docimgsplit811pngAug_ft_Alinew2types_noAug/')
    main()
