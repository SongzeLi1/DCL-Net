...
# python train_Alinew_split811.py
import os
import torch
...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_size", type=int, default=4*2)
    ...
    train_resize = (768, 768) #  (512, 512) None
    resize = train_resize
    print('resize:', resize)

    save_path = os.path.join('/data1/zhengkengtao/exps/0729_MVSSNet_Alinew_train_split811_resize768/')
    main()
