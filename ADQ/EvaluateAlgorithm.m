...
all_algorithm_name = {'ELA', 'CAGI'};
% all_datasetName = {'docimg_split811_test', 'Alinew_trainsplit811_test'};
all_datasetName = {'supat_tamperall', 'docimg_all', 'Alinew_trainall'};
...
all_spliceDataPath = {'E:/datasets/SUPATLANTIQUE/SUPATLANTIQUE/tamper/', 'E:/datasets/docimg/tamper_mosaic/', 'E:/datasets/Ali_new/forgery_round1_train_20220217/train/img/'};
for i = 1:length(all_algorithm_name)
    for j = 1:length(all_datasetName)
        ...
        Options.OutputPath = strcat('E:/0730_handcraft_test/',Options.AlgorithmName,'/',Options.DatasetName,'/');
