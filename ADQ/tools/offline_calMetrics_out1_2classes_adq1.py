...
testresult_dir = '/data1/zhengkengtao/exps/0730_handcraft_test/ADQ1/docimg_all/'
map_path = testresult_dir + 'Output_map/'
pred_path = testresult_dir +  'threshold_0.5/'
save_metrics_path = '/data1/zhengkengtao/exps/0730_handcraft_test/ADQ1/docimg_split811test/'
