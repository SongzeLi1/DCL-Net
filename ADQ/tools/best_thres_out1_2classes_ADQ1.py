...
# nes = os.listdir(path)
# dir = '/data1/zhengkengtao/exps/0730_handcraft_methods/ADQ1/docimg_all/threshold_0.5/'
# dstdir = '/data1/zhengkengtao/exps/0730_handcraft_methods/ADQ1/docimg_split811test/threshold_0.5/'
# ns = os.listdir(dir)
# ns.sort()
# for n in ns:
#     if n in nes:
#         shutil.copyfile(dir+n, dstdir+n)
...
testresult_dir = '/data1/zhengkengtao/exps/0730_handcraft_methods/ADQ1/Alinew_trainall/'
...
for i in range(len(filenames)):
    ...
    halfthrespred = (map > 0.5).astype(np.uint8)
