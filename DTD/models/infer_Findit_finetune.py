...
device = 'cuda'
n_class = 3
mask_threshold, viz, save_map, save_mask, cal_metrics, batch_size = None, True, True, True, False, 8*20
input_size = [512, 512]
patch_size, patch_stride = None, None
tta_scale = None
# ---------------
# 鲁棒性实验：修改路径image_dataset_path，test_img_path, save_results_path
image_dataset_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_imgs/" #'/pubdata/zhengkengtao/docimg/docimg_split811/test_images/'
gt_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_gt3/" # '/pubdata/zhengkengtao/docimg/docimg_split811/test_gt3/'
test_img_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_imgs_imgs_crop512stride256/" #'/pubdata/lisongze/docimg/exam/docimg2jpeg/test_images_75_100/'
test_gt_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_gt3_crop512stride256/" # '/pubdata/zhengkengtao/docimg/docimg_split811/crop512x512/test_gt3_crop512stride256/'
checkpoint_dir = "/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Findit_finetune/dtd_512x512/fold_0_best-ckpt.pth"
save_results_path = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Findit_finetune/test_result/' # JPEG/jpg_100/
# ---------------
...
for i in range(len(filenames)):
    ...
    if gt_path is not None:
        ...
        gt_name = name.replace('psc_', 'gt3_psc_')
        gt_name = gt_name.replace('ps_', 'gt3_ps_')
        gt_name = gt_name.replace('mosaic_', 'gt3_mosaic_')
        gt_name = gt_name.replace('orig_', 'gt3_orig_')
    ...
    if 'ps_' in name:
        ...
        fprauthentic.append(fpr1)
        fprauthentic.append(fpr2)
...
fprauthentic_mean = np.mean(fprauthentic)
print('======================================================================================================')
print(
    'test num:{}, f1foregry:{:.3f}, aucforgery:{:.3f}, fprforgery:{:.3f}, f1mosaic:{:.3f}, aucmosaic:{:.3f}, fprmosaic:{:.3f}, fprauthentic:{:.3f}'
    .format(len(filenames), f1forgery_mean, aucforgery_mean, fprforgery_mean, f1mosaic_mean, aucmosaic_mean,
            fprmosaic_mean, fprauthentic_mean))
f = open(metrics_csv, 'a+', newline='')
csv_writer = csv.writer(f)
csv_writer.writerow(['Average', len(filenames),
                     ...
                     miou_mean, mauc_mean, pa_mean, mpa_mean, aucmosaic_mean])
csv_writer.writerow(
