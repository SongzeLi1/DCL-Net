...
parser.add_argument('--data_root', type=str, default="/pubdata/lisongze/DocTamperV1/")     # root to the dir of lmdb files
parser.add_argument('--pth', type=str, default='../pths/dtd_doctamper.pth')
parser.add_argument('--lmdb_name', type=str, default='DocTamperV1-FCD')      # DocTamperV1-FCD
...
class TamperDataset(Dataset):
    def __init__(self, roots, mode, minq=95, qtb=90, max_readers=64):
        ...
        with open('../pks/' + args.lmdb_name + '_%d.pk' % minq, 'rb') as f:
...
def eval_net_dtd(model, test_data, plot=False,device='cuda'):
    train_loader1 = DataLoader(dataset=test_data, batch_size=8, num_workers=8, shuffle=False)
