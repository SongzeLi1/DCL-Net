...
image_dataset_path = "/pubdata/zhengkengtao/findit/findit_4types/split_100_20_600/test_imgs/" #'/pubdata/zhengkengtao/docimg/docimg_split811/test_images/'
gt_path = "/pubdata/zhengkengtao/findit/findit_4types/split_100_20_600/test_gt3/"
test_img_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/crop512_stride256/test_imgs_crop512stride256/" #'/pubdata/lisongze/docimg/exam/docimg2jpeg/test_images_75_100/'
test_gt_path = "/pubdata/zhengkengtao/findit/findit_4types/split_100_20_600/crop512_stride256/test_gt3_crop512stride256/"
checkpoint_dir = "/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/detection_type1/dtd_512x512/fold_0_best-ckpt.pth"
save_results_path = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Findit_directly/test_result_102/' # JPEG/jpg_100/
# ---------------
...
metrics_csv = save_metrics_path + "3kinds_metric_findit_directly.csv"
...
for i in range(len(filenames)):
    ...
    if gt_path is not None:
        ...
        gt_name = gt_name.replace('psc_', 'gt3_psc_')
