...
device = 'cuda'
n_class = 3
mask_threshold, viz, save_map, save_mask, cal_metrics, batch_size = None, True, True, True, False, 8*50
input_size = [256, 256]
patch_size, patch_stride = None, None
tta_scale = None
# ---------------
# 鲁棒性实验：修改路径image_dataset_path，test_img_path, save_results_path
image_dataset_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/Ali_new/split_1000_200_2800/test_imgs/" #'/pubdata/zhengkengtao/docimg/docimg_split811/test_images/'
gt_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/Ali_new/split_1000_200_2800/test_gt3/" # '/pubdata/zhengkengtao/docimg/docimg_split811/test_gt3/'
test_img_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/Ali_new/split_1000_200_2800/test_imgs_crop256stride128/" #'/pubdata/lisongze/docimg/exam/docimg2jpeg/test_images_75_100/'
test_gt_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/Ali_new/split_1000_200_2800/test_gt3_crop256stride128/" # '/pubdata/zhengkengtao/docimg/docimg_split811/crop512x512/test_gt3_crop512stride256/'
checkpoint_dir = "/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Alinew_finetune/dtd_256x256/fold_0_best-ckpt.pth"
save_results_path = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Alinew_finetune/test_result/' # JPEG/jpg_100/
# ---------------
...
block_read_path = dst_dir + 'pred256x256/'
merge_write_path = dst_dir + 'predblockmerge/'
mapblock_read_path = dst_dir + 'map256x256/'
...
metrics_csv = save_metrics_path + "3kinds_metric_Alinew_finetune.csv"
