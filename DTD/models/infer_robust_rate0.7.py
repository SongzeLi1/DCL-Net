...
device = 'cuda'
n_class = 3
mask_threshold, viz, save_map, save_mask, cal_metrics, batch_size = None, True, True, True, False, 60
input_size = [256, 256]
patch_size, patch_stride = None, None
tta_scale = None
# ---------------
# 鲁棒性实验：修改路径image_dataset_path，test_img_path, save_results_path
image_dataset_path = '/pubdata/lisongze/docimg/exam/docimg2jpeg/test_robust/resize/rate0.7/' #'/pubdata/zhengkengtao/docimg/docimg_split811/test_images/'
gt_path = '/pubdata/lisongze/docimg/exam/docimg2jpeg/test_robust/resize_gt3/rate0.7/' # '/pubdata/zhengkengtao/docimg/docimg_split811/test_gt3/'
test_img_path = '/pubdata/lisongze/docimg/exam/docimg2jpeg/test_robust/resize/rate0.7_crop256stride128/' #'/pubdata/lisongze/docimg/exam/docimg2jpeg/test_images_75_100/'
test_gt_path = '/pubdata/lisongze/docimg/exam/docimg2jpeg/test_robust/resize_gt3/rate0.7_crop256stride128/' # '/pubdata/zhengkengtao/docimg/docimg_split811/crop512x512/test_gt3_crop512stride256/'
checkpoint_dir = "/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/robust/dtd_512x512/fold_0_best-ckpt.pth"
save_results_path = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/robust/test_result/Scaling/rate0.7/' # JPEG/jpg_100/
# ---------------
...
for batch_idx, batch_samples in enumerate(test_loader):
    ...
    for i in range(pred.shape[0]):
        ...
        #     pred_ = cv2.resize(pred_, (wd, ht), interpolation=cv2.INTER_NEAREST)
...
metrics_csv = save_metrics_path + "3kinds_metric_robust_rate0.7.csv"
