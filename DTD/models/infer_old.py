from ConTDNet.utils.utils import inial_logger
from scipy.io import loadmat
import albumentations as A
from albumentations.pytorch import ToTensorV2
from ConTDNet.utils import colorEncode
from torch.utils.data import Dataset, DataLoader
# from networks.difnetv2.difnetv2 import *
from ConTDNet.utils.segmetric import *
import torch
import torch.nn.functional as F
import cv2
from PIL import Image, ImageFile
from ConTDNet.utils.metric import *
import time
import logging
...
import numpy as np
import os
from ConTDNet.contdnet.contdnet import *
...
if __name__=="__main__":
    ...
    checkpoint_dir = '/pubdata/zhengkengtao/exps/ConTDNet_jointrain_noblank_quater_bce001_bs64/contdnet_512x512/fold_0_best-ckpt.pth'
    save_results_path = '/pubdata/zhengkengtao/exps/test_results/2023-7-3-loc-noblank_quater_bce001_best_4/'
    # --------------
    ...
    # ----------------merge----------------------
    from ConTDNet.merge import get_row, get_col
    ...
    for i in range(len(filenames)):
        ...
        if gt_path is not None:
            ...
            gt_name = gt_name.replace('ps_', 'gt3_')
