...
if __name__=="__main__":
    n_class = 1
    device = 'cuda'
    mask_threshold, viz, save_map, save_mask, batch_size = None, False, False, False, 8*30
    input_size = [512, 512]
    stride = 512
    checkpoint_dir = "/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Findit_finetune/cls_2class/dtd_512x512/fold_0_best-ckpt.pth"
    save_results_path = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Findit_finetune/cls_2class/test_result_1/'
    ...
    # 图像块
    test_img_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_imgs_crop512stride512/"  # '/pubdata/lisongze/docimg/exam/docimg2jpeg/test_images_75_100/'
    test_gt_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_gt3_crop512stride512/"
    filenames = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_imgs_crop512stride512/"
    filenames = os.listdir(filenames)
    filenames.sort()
    # 整图
    image_name_list = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/test_imgs/"
