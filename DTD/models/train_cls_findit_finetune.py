...
param['save_train_dir'] = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Findit_finetune/cls_2class_106/'
...
# 准备数据集
train_img_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/train_imgs_imgs_crop512stride256/"
train_gt_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/train_gt3_crop512stride256/"
train_names = os.listdir(train_img_path)
train_names.sort()
val_img_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/val_imgs_imgs_crop512stride256/"
val_gt_path = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/val_gt3_crop512stride256/"
val_names = os.listdir(val_img_path)
val_names.sort()

logger.info('Training started')
logger.info("train: {} valid: {}".format(len(train_names), len(val_names)))
train_data = DOCDataset(train_names, train_img_path, train_gt_path, transform=train_transform(param['input_size']))
valid_data = DOCDataset(val_names, val_img_path, val_gt_path, transform=val_transform(param['input_size']))
