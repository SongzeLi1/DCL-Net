...
param['save_train_dir'] = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/Findit_finetune/'
...
# 准备数据集
data_dir = '/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/'#'/pubdata/zhengkengtao/docimg/docimg_split811/crop512x512/patch_noblank/'
train_imgs_dir = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/train_imgs_imgs_crop512stride256/"#'/pubdata/lisongze/docimg/exam/docimg2jpeg/train_images_75_100/'
# train_imgs_dir = os.path.join(data_dir, "train_images/")
train_labels_dir = os.path.join(data_dir, "train_gt3_crop512stride256/")
val_imgs_dir = "/pubdata/lisongze/docimg/exam/docimg2jpeg/findit/split_100_20_600/val_imgs_imgs_crop512stride256/"#'/pubdata/lisongze/docimg/exam/docimg2jpeg/val_images_75_100/'
# val_imgs_dir = os.path.join(data_dir, "val_images/") # val_images
val_labels_dir = os.path.join(data_dir, "val_gt3_crop512stride256/") # val_gt3
