...
if __name__=="__main__":
    n_class = 1
    device = 'cuda'
    mask_threshold, viz, save_map, save_mask, batch_size = None, False, False, False, 4*30
    input_size = [512, 512]
    stride = 512
    checkpoint_dir = "/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/cls_2class_102/dtd_512x512/fold_0_best-ckpt.pth"
    save_results_path = '/pubdata/lisongze/DCLNet/result/DTDNet_crop512x512/cls_2class_102/test_result/'
    ...
    filenames = glob.glob('/pubdata/lisongze/docimg/exam/docimg2jpeg/test/testorig_crop512stride{}/*.jpg'.format(stride)) + \
                glob.glob('/pubdata/lisongze/docimg/exam/docimg2jpeg/test/test_images_crop512stride{}/*.jpg'.format(stride)) + \
